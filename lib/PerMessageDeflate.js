...
class PerMessageDeflate {
  ...
  decompress (data, fin, callback) {
    ...
    if (this.params[endpoint + '_no_context_takeover']) {
      return zlib.inflateRaw(data, opts, callback);
    }
  ...
  compress (data, fin, callback) {
    ...
    if (this.params[endpoint + '_no_context_takeover']) {
      return zlib.deflateRaw(data, opts, callback);
    }
    ...
    this._deflate.flush(opts.flush, function () {
      cleanup();
